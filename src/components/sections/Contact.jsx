      ...
      <div className="relative mx-auto grid max-w-7xl gap-20 px-6 lg:grid-cols-2">
        ...
        <Reveal direction="left">
          ...
          <p className="mt-8 max-w-xl text-lg leading-8 text-slate-400">
            I'm a Computer Science student passionate about software, web
            development, game development, and AI. I'm always excited to
            collaborate, learn from experienced developers, and contribute to
            meaningful projects.
          </p>
          ...
          <Stagger className="mt-12 space-y-6">
            ...
            <motion.div variants={staggerItem} className="flex gap-4 pt-3">
              <a
        ...
        >
          ...
          >
            ...
            <p className="mt-3 text-slate-400">
              Have an opportunity, collaboration, or just want to say hello? I'd
